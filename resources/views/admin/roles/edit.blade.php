<x-panel-layout>
    <x-main-card>
        <x-slot name="panel_header">
            {{ __('panel.edit') }} {{ __('panel.role.title_singular') }}
        </x-slot>
        ...
        <form method="POST" action="{{ route("admin.roles.update", [$role->id]) }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <x-input id="label" type="text" name="label" class="block mt-1 lg:w-2/5 w-full {{ $errors->has('label') ? 'border-red-500' : '' }}" value="{{ old('label', $role->label) }}"  required></x-input>
            ...
            <div class="mt-3">
                ...
                <x-input id="title" type="text" name="title" class="block mt-1 lg:w-2/5 w-full {{ $errors->has('title') ? 'border-red-500' : '' }}" value="{{ old('title', $role->title) }}"  required></x-input>
            </div>

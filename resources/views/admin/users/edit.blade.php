<x-panel-layout>
    <x-main-card>
        <x-slot name="panel_header">
            {{ __('panel.edit') }} {{ __('panel.user.title_singular') }}
        </x-slot>
        ...
        <!-- Name -->
            <div>
                ...
                <x-input id="name" type="text" name="name" class="block mt-1 lg:w-2/5 w-full {{ $errors->has('name') ? 'border-red-500' : '' }}" value="{{ old('name', $user->name) }}" required></x-input>
            ...
            <div class="mt-3">
                ...
                <x-input id="email" type="email" name="email" class="block mt-1 lg:w-2/5 w-full {{ $errors->has('email') ? 'border-red-500' : '' }}" value="{{ old('email', $user->email) }}" required></x-input>
            </div>
            ...
            <div class="mt-3">
                ...
                <x-input id="password" type="password" name="password" class="block mt-1 lg:w-2/5 w-full {{ $errors->has('password') ? 'border-red-500' : '' }}" value="{{ old('password') }}" required></x-input>
            </div>
